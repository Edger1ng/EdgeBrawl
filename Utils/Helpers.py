...
class Helpers:
    ...
    def load_account(self, player_data):
        ...
        self.player.account_ban = player_data['Ban']
        self.player.ban_reason = player_data['BanReason']
        self.player.ban_support = player_data['BanSupport']
        self.player.maintenance = player_data['Maintenance']
        self.player.maintenance_type = player_data['MaintenanceType']
        self.player.maintenance_text = player_data['MaintenanceText']
        self.player.buyed = player_data['Buyed']
        self.player.donate_level = player_data['DonateLvl']
        self.player.battle_multiplier = player_data['BattleMultiplier']
        self.player.premium = player_data['PremiumActivated']
        self.player.beta_enabled = player_data['BetaEnabled']
        self.player.first_donate = player_data['FirstDonate']
        self.player.premium = player_data['PremiumActivated']
        self.player.donate_season = player_data['DonateSeason']
        self.player.tempban_date = player_data['TempbanDate']
        self.player.notifications = player_data['Notifications']
        self.player.m_time = player_data['MultiplierTime']
        self.player.pass_tokens = player_data['PassTokens']
        self.player.bp_progress = player_data['SeasonProgress']
