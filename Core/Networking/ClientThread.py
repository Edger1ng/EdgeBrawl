            ...
            while True:
                ...
                if len(header) > 0:
                    ...
                    if packet_id in packets:
                        ...
                        _(f'{Helpers.blue}[CLIENT] PacketID: {packet_id}, Name: {packet_name} Length: {packet_length}    ip: {self.address[0]}')


                        if packet_id == 10101:
                            message = packets[packet_id](self.client, self.player, packet_data, self.address)
                        else:
                        ...
                        _(f'{Helpers.cyan}[CLIENT] Unhandled Packet! ID: {packet_id}, Length: {packet_length}    ip: {self.address[0]}')
